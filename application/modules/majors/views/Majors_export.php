...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Master Majors<br/ >Effective Date : <?php echo date('d M Y'); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $value->majorid ?></td>
                      <td><?php echo $value->majorname ?></td>
