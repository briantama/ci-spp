...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Cash In<br/ >Effective Date : <?php echo date('d M Y'); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <?php
                    if($datacash){
                     foreach($datacash as $value){ 
                    ?>
                    
                    <tr>
                      <td><?php echo $value->cashinid ?></td>
                      <td><?php echo $value->cashdate ?></td>
                      <td style="text-align: right;"><?php echo number_format($value->cashamount) ?></td>
