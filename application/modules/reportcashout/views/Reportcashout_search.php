<?php
    ...
    $str .= "<div class='cap'>";
    $str.= "<a href='".base_url()."reportcashout/viewReportCashOut/print/".urlencode(serialize($keys))."?StartDate=".$StartDate."&EndDate=".$EndDate."' target='/_blank' class='btn btn-icon icon-left btn-secondary' style='margin-left:10px;'><i class='fa fa-print'></i> print</a>";
    $str.= "<a href='".base_url()."reportcashout/viewReportCashOut/export/".urlencode(serialize($keys))."?StartDate=".$StartDate."&EndDate=".$EndDate."' target='/_blank' class='btn btn-icon icon-left btn-success' style='margin-left:10px;'><i class='fa fa-file-excel'></i> export</a>";
    $str.= "<div class='cap' style='text-align: center; font-weight: bold;'> Report Cash Out<br/ >Effective Date : ".date_format(date_create($StartDate),"d F Y")." - ".date_format(date_create($EndDate),"d F Y");
    $str .= "</div>";
    $str .= "</div>";
    $str .= "</div>";
    ...
    if(!empty($keys)){
      ...
      foreach($keys as $value){ 
        ...
        $str .= "<td nowrap title=\"cashoutid\">". $value->cashoutid  ."</td>";
        ...
        $str .= "<td nowrap title=\"TotalSavings\" style=\"text-align: right;\">". number_format($value->cashamountout) ."</td>";
        $str .= "</tr>";
        $x++;
      }
      $str .= "<tr class='total'>";
      $str .= "<td colspan='4'>Total Cash Out</td>";
      ...
      $str .= "<div class=\"info\">No Data Cash Out</div>";
    }
