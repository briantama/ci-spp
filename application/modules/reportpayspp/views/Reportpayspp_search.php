<?php
    ...
    $str .= "<div class='cap'>";
    $str.= "<a href='".base_url()."reportpayspp/viewReportpayspp/print/".urlencode(serialize($keys))."?Period=".$Period."' target='/_blank' class='btn btn-icon icon-left btn-secondary' style='margin-left:10px;'><i class='fa fa-print'></i> print</a>";
    $str.= "<a href='".base_url()."reportpayspp/viewReportpayspp/export/".urlencode(serialize($keys))."?Period=".$Period."' target='/_blank' class='btn btn-icon icon-left btn-success' style='margin-left:10px;'><i class='fa fa-file-excel'></i> export</a>";
